      ...
      <div className="flex ">
        ...
        <main className="flex-1 p-6 ">
          ...
          <div className="flex items-center justify-evenly mt-20">
            <Link href="/bankingSummary">    <div className="w-40 text-center hover:scale-107 transition ease-in duration-200 hover:bg-green-400 flex flex-col justify-between h-40 rounded-lg p-3 bg-green-300">
              <p>Get Banking Summary</p>
              <p>Get Customer Transaction History</p>
            </div></Link>
            <Link href="/LoanSummary">
              <div className="w-40 text-center hover:scale-107 transition ease-in duration-200 hover:bg-green-400 flex flex-col justify-between h-40 rounded-lg p-3 bg-green-300">
